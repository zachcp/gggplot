...
export function emitSource(root: RenderNode, name = "GGChart"): string {
  ...
  const liveImports = faceted || radial
    ? radial ? "createElement, Fragment, provide, useContext, useMemo" : "createElement, Fragment, useContext"
    : "createElement, Fragment";
  const workbenchImports = [
    ...(faceted || radial ? ["LayoutContext"] : []),
    ...(radial ? ["MatrixContext", "TransformContext", "useCombinedMatrixTransform"] : []),
  ];
...
${facetGridDef}${radialViewportDef}
